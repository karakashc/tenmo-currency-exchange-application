...
-- Populate the transfer table:
INSERT INTO transfer (from_user_id, to_user_id, transfer_amount, status)
VALUES  (1001, 1002, 100.00, true),
        (1002, 1001, 100.00, true);
